# 🚀 GitHub Setup Guide for Raffna's Birthday Site
...
4. Fill in the details:
   - **Repository name**: `raffna-birthday-site` (or choose your own name)
...
git remote add origin https://github.com/YOUR-USERNAME/raffna-birthday-site.git
...
7. You'll see: **"Your site is live at https://YOUR-USERNAME.github.io/raffna-birthday-site/"**
...
1. Replace `music/raffna.mp3` with your music file
